...
final class CafeManager {
    ...
    var cafeItems: [CafeItem] = [
        Cafe(varName: "onion", cafeName: "어니언", cafeDesc: "분위기 좋은", cafeLocation: "성동구 아차산로9길 8", cafeGeo: .init(latitude: 37.544786, longitude: 127.058119), images: ["어니언01", "어니언02", "어니언03"], favorite: false),
        Cafe(varName: "daelim", cafeName: "대림창고", cafeDesc: "창고형 카페", cafeLocation: "성동구 성수이로 78", cafeGeo: .init(latitude: 37.5419534, longitude: 127.0562899), images: ["대림창고1", "대림창고2", "대림창고3"], favorite: false),
    ]
